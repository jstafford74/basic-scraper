...
from models.snapshots import SnapshotsModel
...
class SnapshotsController:
    def __init__(self):
        ...
        self.model = SnapshotsModel(
            os.getenv("DATABASE_NAME"), os.getenv("SNAPSHOTS_COLLECTION")
        )
    ...
    def update_one_document(self, filter, updates,upsert=False):
